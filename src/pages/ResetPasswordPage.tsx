...
const ResetPassword: React.FC =()=>{
   ...
   const handleSubmit = async(e: React.FormEvent) =>{
    ...
    return(<div className="container text-center"><h2 style={{color:'#006D5B', fontWeight:'bold', marginBottom:'20px'}}>Get Back Into Your Account
    </h2>
    <p>
    ...
    <form>
        ...
        {showButtons ?
         ( <div className="container text-center"><label htmlFor ="code" style={{fontWeight:'bold'}}>Verification Code
